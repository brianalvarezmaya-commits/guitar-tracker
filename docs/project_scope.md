# Alcance del Proyecto: "GuitarTracker"
...
1. Registro de guitarras (marca, modelo, tipo: eléctrica, acústica, etc.)
2. Visualización en formato de tarjetas (cards)
3. Estado de la guitarra (Nueva, Usada, En reparación)
4. Lista de guitarras registradas
